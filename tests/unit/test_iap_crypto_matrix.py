...
lockfile is installed, the gate sets ``DATAQUALITY_REQUIRE_IAP_MATRIX=1`` and
...
from data_quality_governance.config import Settings
...
_REQUIRE_ENV = "DATAQUALITY_REQUIRE_IAP_MATRIX"
