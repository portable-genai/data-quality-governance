...
from data_quality_governance.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("data_quality_governance.adapters.gcp.identity")
