# Data Quality and Governance Agent (H4) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    DATAQUALITY_PROFILE=gcp \
    DATAQUALITY_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m data_quality_governance.managed_readiness && exec uvicorn data_quality_governance.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
