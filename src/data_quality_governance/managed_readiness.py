...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "baseline_store.CloudBaselineStore.get_baseline",
    "baseline_store.CloudBaselineStore.put_baseline",
    "catalog.CloudCatalogAdapter.downstream",
    "catalog.CloudCatalogAdapter.owner",
    "catalog.CloudCatalogAdapter.tags",
    "warehouse.CloudWarehouseAdapter.live_schema",
    "warehouse.CloudWarehouseAdapter.metadata",
    "warehouse.CloudWarehouseAdapter.sample_columns",
)
