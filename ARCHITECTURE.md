# ARCHITECTURE: Data Quality and Governance Agent (H4)

Hexagonal ports-and-adapters. A pure-stdlib domain core speaks only to ports (`typing.Protocol`s);
adapter families implement them; one env var (`DATAQUALITY_PROFILE`) swaps the
...
## Layout (`src/data_quality_governance/`)
